export const enum Sprites {
    ...
    edge = "edge",
    elf_f_hit_anim = "elf_f_hit_anim",
    elf_m_hit_anim = "elf_m_hit_anim",
    ...
    hole = "hole",
    knight_f_hit_anim = "knight_f_hit_anim",
    knight_m_hit_anim = "knight_m_hit_anim",
    skull = "skull",
    ...
    weapon_anime_sword = "weapon_anime_sword",
    weapon_axe = "weapon_axe",
    weapon_baton_with_spikes = "weapon_baton_with_spikes",
    weapon_big_hammer = "weapon_big_hammer",
    weapon_cleaver = "weapon_cleaver",
    weapon_duel_sword = "weapon_duel_sword",
    weapon_golden_sword = "weapon_golden_sword",
    weapon_green_magic_staff = "weapon_green_magic_staff",
    weapon_hammer = "weapon_hammer",
    weapon_katana = "weapon_katana",
    weapon_knife = "weapon_knife",
    weapon_knight_sword = "weapon_knight_sword",
    weapon_lavish_sword = "weapon_lavish_sword",
    weapon_mace = "weapon_mace",
    weapon_machete = "weapon_machete",
    weapon_red_gem_sword = "weapon_red_gem_sword",
    weapon_red_magic_staff = "weapon_red_magic_staff",
    weapon_regular_sword = "weapon_regular_sword",
...
export const enum Animations {
    ...
    big_demon_run_anim = "big_demon_run_anim",
    big_zombie_idle_anim = "big_zombie_idle_anim",
    big_zombie_run_anim = "big_zombie_run_anim",
    ...
    chort_idle_anim = "chort_idle_anim",
    chort_run_anim = "chort_run_anim",
    coin_anim = "coin_anim",
    elf_f_idle_anim = "elf_f_idle_anim",
    elf_f_run_anim = "elf_f_run_anim",
    elf_m_idle_anim = "elf_m_idle_anim",
    elf_m_run_anim = "elf_m_run_anim",
    floor_spikes_anim = "floor_spikes_anim",
    goblin_idle_anim = "goblin_idle_anim",
    goblin_run_anim = "goblin_run_anim",
    ice_zombie_idle_anim = "ice_zombie_idle_anim",
    ice_zombie_run_anim = "ice_zombie_run_anim",
    imp_idle_anim = "imp_idle_anim",
    imp_run_anim = "imp_run_anim",
    knight_f_idle_anim = "knight_f_idle_anim",
    knight_f_run_anim = "knight_f_run_anim",
    knight_m_idle_anim = "knight_m_idle_anim",
    knight_m_run_anim = "knight_m_run_anim",
    masked_orc_idle_anim = "masked_orc_idle_anim",
    masked_orc_run_anim = "masked_orc_run_anim",
    muddy_idle_anim = "muddy_idle_anim",
    muddy_run_anim = "muddy_run_anim",
    necromancer_idle_anim = "necromancer_idle_anim",
    necromancer_run_anim = "necromancer_run_anim",
    ogre_idle_anim = "ogre_idle_anim",
    ogre_run_anim = "ogre_run_anim",
    orc_shaman_idle_anim = "orc_shaman_idle_anim",
    orc_shaman_run_anim = "orc_shaman_run_anim",
    orc_warrior_idle_anim = "orc_warrior_idle_anim",
    orc_warrior_run_anim = "orc_warrior_run_anim",
    skelet_idle_anim = "skelet_idle_anim",
    skelet_run_anim = "skelet_run_anim",
    swampy_idle_anim = "swampy_idle_anim",
    swampy_run_anim = "swampy_run_anim",
    tiny_zombie_idle_anim = "tiny_zombie_idle_anim",
    tiny_zombie_run_anim = "tiny_zombie_run_anim",
    ...
    wizzard_f_idle_anim = "wizzard_f_idle_anim",
    wizzard_m_idle_anim = "wizzard_m_idle_anim",
    wizzart_f_run_anim = "wizzart_f_run_anim",
    wizzart_m_run_anim = "wizzart_m_run_anim",
    wogol_idle_anim = "wogol_idle_anim",
