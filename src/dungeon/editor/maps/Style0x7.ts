...
export class Style0x7 extends BaseStyle {
    ...
    BottomRight(): Brush[] {
        return this.Fill(
            ["wall_inner_corner_l_top_rigth", "wall_top_right"], this.rect.x + this.rect.width, this.rect.y + this.rect.height - 1)
    ...
    Floor(): Brush[] {
        ...
        const floorTiles = {floor_1: 900, floor_2: 5, floor_3: 5, floor_4: 1, floor_5: 5};
